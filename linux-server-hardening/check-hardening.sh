...
FIX_UFW_ACTIVE="Ensure UFW is enabled using 'sudo ufw enable'. The 'install-packages.sh' script should handle this."
...
FIX_UFW_POLICY="Set defaults: 'sudo ufw default deny incoming' and 'sudo ufw default allow outgoing'. 'install-packages.sh' should handle this."
